...
//! policy. The crate will be re-implemented from scratch against ITU-T
//! Recommendation H.265 / ISO/IEC 23008-2 in a future clean-room
//! round.
//!
...
impl core::fmt::Display for Error {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        write!(
            f,
            "oxideav-h265: orphan-rebuild scaffold — no decoder/encoder wired up"
        )
    }
}
