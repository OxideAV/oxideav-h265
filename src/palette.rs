...
use crate::binarization::{
    decode_cu_chroma_qp_offset, decode_cu_qp_delta, decode_eg_k, palette_run_prefix_ctx_inc,
    palette_run_prefix_tr_cmax, read_truncated_rice_prefix, CuChromaQpOffset, CuQpDelta,
};
use crate::cabac::{CabacEngine, CabacError};
...
/// [`crate::transform_unit::QuantGroupState`]).
///
/// # Errors
...
pub fn decode_palette_coding(
    ...
    qg: &mut crate::transform_unit::QuantGroupState,
    n_cbs: usize,
...
mod tests {
    ...
    use crate::transform_unit::QuantGroupState;
    ...
    fn palette_coding_roundtrips_hand_built_block() {
        ...
        let mut engine =
            CabacEngine::new(crate::bitreader::BitReader::new(&bytes)).expect("engine");
