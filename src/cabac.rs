...
pub const LAST_SIG_COEFF_X_PREFIX_INIT_VALUES: [[u8; 18]; 3] = [
    ...
    [125, 110, 124, 110,  95,  94, 125, 108, 111, 111,  79, 125, 126, 111, 111,  79, 108, 123],
];
...
/// `sig_coeff_flag` (Table 9-26). 42 contexts per initType.
#[rustfmt::skip]
pub const SIG_COEFF_FLAG_INIT_VALUES: [[u8; 42]; 3] = [
    [
        111, 111, 125, 110, 110,  94, 124, 108, 124, 107, 125, 141,
        183, 154, 183, 153, 140, 140, 140, 140, 140,
        140, 140, 140, 136, 139, 111, 141, 111, 140, 140, 140, 140, 140,
        140, 140, 140, 121, 140, 140, 140, 140,
    ],
    [
        155, 154, 139, 153, 153, 123, 123,  63, 153, 153, 153, 152,
        152, 134, 137, 136, 167, 227, 152, 152, 152,
        152, 152, 152, 121, 136, 137, 169, 140, 152, 152, 152, 152, 152,
        152, 152, 152, 121, 152, 152, 152, 152,
    ],
    [
        170, 154, 139, 153, 123, 123, 107, 121, 107, 121, 167, 151,
        183, 140, 151, 183, 140, 140, 152, 152, 152,
        152, 152, 152, 121, 136, 137, 169, 140, 152, 152, 152, 152, 152,
        152, 152, 152, 121, 152, 152, 152, 152,
    ],
];

/// `coeff_abs_level_greater1_flag` (Table 9-27). 24 contexts.
#[rustfmt::skip]
pub const COEFF_ABS_GT1_INIT_VALUES: [[u8; 24]; 3] = [
    [140,  92, 138, 112, 164, 128, 154, 196, 167, 128, 158, 154, 154,
     197, 167, 154, 149, 154, 154, 154, 154, 167, 154, 154],
    [154, 176, 153, 168, 140, 198, 168,  79, 197, 180, 140, 154, 153,
     183, 168, 110, 168, 210, 120, 161, 124, 170,  84, 126],
    [154, 176, 167, 167, 140, 154, 167, 109, 197, 181, 140, 154, 170,
     183, 168, 125, 155, 154, 139, 196, 165, 154, 140, 155],
];
